      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden relative">
            ...
            <div className="flex flex-col md:flex-row justify-between relative z-10">
              ...
              <div className="flex flex-col items-end">
                ...
                <div className="bg-white p-2 rounded-lg">
                  <img 
                    src="/lovable-uploads/87ea43d0-4f26-4387-bab6-edd3f20e0076.png" 
                    alt="QR Code"
                    className="w-24 h-24"
                  />
                </div>
          ...
          <div className="p-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* What is Amanah? */}
            <div className="bg-white dark:bg-gray-750 dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm">
