...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: "/lovable-uploads/08c97f75-e80d-4b1a-83c2-ee83cddea59c.png",
    developers: ["dokkar-chaima", "belouahar-sofia", "zerguini-maylis", "benamaouche-sonia"],
    supervisor: "bouakkaz-madjeda",
    technologies: ["react-native", "firebase", "mongodb"],
    department: "mobile-development",
    github: "https://github.com/ensta/unihub",
    demo: "/projects/unihub",
    date: "2025-05-01",
    logo: "/lovable-uploads/4b7df4d9-5325-4499-a3c7-172b378da5e1.png",
  },
];
